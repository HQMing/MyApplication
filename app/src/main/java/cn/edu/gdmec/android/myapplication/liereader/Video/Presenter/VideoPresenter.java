package cn.edu.gdmec.android.myapplication.liereader.Video.Presenter;
...
import cn.edu.gdmec.android.myapplication.liereader.Video.Model.IVideoLoadListener;
import cn.edu.gdmec.android.myapplication.liereader.Video.Model.IVideoModel;
import cn.edu.gdmec.android.myapplication.liereader.Video.Model.VideoModel;
import cn.edu.gdmec.android.myapplication.liereader.Video.View.IVideoView;
...
public class VideoPresenter implements IVideoPresenter,IVideoLoadListener{
    ...
    public static String getVideoContentApi(String videoid) {
        ...
        String url = VIDEO_HOST + s + "&s=" + crcString; return url;
    }
